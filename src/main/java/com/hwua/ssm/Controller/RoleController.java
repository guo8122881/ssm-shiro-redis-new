...
public class RoleController {
    ...
    @RequestMapping(value = "/queryRole2",produces = "text/html;charset=UTF-8")
    @ResponseBody
    public String queryRole2(Role role){
    ...
    @RequiresPermissions(value = "role_auths")
    ...
    @RequiresPermissions(value = "role_grant")
    ...
    @RequiresPermissions(value = "user_roles")
