...
<div id="mm" class="easyui-menu" style="width:120px;">
    ...
    <div onclick="delAuthTree()" data-options="iconCls:'icon-delete'">删除</div>
    <div onclick="reloadAuthTree()" data-options="iconCls:'icon-reload'">刷新</div>
</div>

<div id="authEditWin" style=".
padding:10px 10px;" align="center">
