...
<head>
    ...
    <script type="text/javascript">
        ...
        function initRoleGrid(){
            $("#roleGrid").datagrid({
                ...
                columns:[[
                    ...
                    {field:'id',title:'状态',width:100,
                        formatter: function(value,row,index){
                                return "<a href='javascript:void(0) 'onclick=showGrantWin("+value+")>分配角色<a/>";
                        }
                    },
                ]],
        ...
        function queryRole(){
            ...
            //指定请求数据的路径
            $("#roleGrid").datagrid("options").url=path+"";
            //返送请求，获取数据
